        ...
        />
        {
            !file ? (
                <div className="text-center my-5">
                    ...
                    <p className="text-xs">Upload Your Payment Rceipt Here</p>
                </div>
            ) : (
                <div className="text-center">
                   <FiImage className="text-primary mb-4 mx-auto" size={28}/>
                   ...
                   <p className="text-sm text-gray-400">
                    ...
                    <button
                        onClick={removeFile}
                        className="flex cursor-pointer gap-2 bg-primary/90 text-white mx-auto rounded mt-4 px-2"
                    >
